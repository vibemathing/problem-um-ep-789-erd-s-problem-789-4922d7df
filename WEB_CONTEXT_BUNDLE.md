...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-789-erd-s-problem-789-4922d7df-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-789"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-789-erd-s-problem-789-4922d7df-v1",
      "problem_contract_sha256": "ab94fa154a988f21cff8b4ee0eec77ecfda89000ac113b5a80eeda70beb173cd",
      "problem_id": "problem:um-ep-789-erd-s-problem-789-4922d7df",
      "route_id": "route:um-ep-789-erd-s-problem-789-4922d7df-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-789-erd-s-problem-789-4922d7df-source-fidelity-01",
      "graph_id": "graph:um-ep-789-erd-s-problem-789-4922d7df-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-789-erd-s-problem-789-4922d7df-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-789-erd-s-problem-789-4922d7df-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $h(n)$ be maximal such that if $A\\subseteq \\mathbb{Z}$ with $\\lvert A\\rvert=n$ then there is $B\\subseteq A$ with $\\lvert B\\rvert \\geq h(n)$ such that if $a_1+\\cdots+a_r=b_1+\\cdots+b_s$ with $a_i,b_i\\in B$ then $r=s$. Estimate $h(n)$."
          },
          "statement_sha256": "93c3c03391a203f9c032662a38a754e299adacf6f14a9c06ffbf631fefe6ed0b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-789-erd-s-problem-789-4922d7df-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-789-erd-s-problem-789-4922d7df-root",
      "route_id": "route:um-ep-789-erd-s-problem-789-4922d7df-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-789-dfd3ccd2e0d3",
        "url": "https://www.unsolvedmath.com/problems/EP-789"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
